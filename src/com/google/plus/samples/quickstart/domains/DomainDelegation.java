...
public class DomainDelegation {
   ...
   */
 private static final String SERVICE_ACCOUNT_EMAIL = "121957370597-n5vmeedhrv0545r3n3rpl989vfguobp7.apps.googleusercontent.com";
 // private static final String SERVICE_ACCOUNT_EMAIL = "arahansa@ttpdomainapiproject.iam.gserviceaccount.com";
  ...
  private static final String SERVICE_ACCOUNT_PKCS12_FILE_PATH =
      "ttpDomainAPIProject-183de003c454.p12";

  /**
   * Update USER_EMAIL with the email address of the user within your domain that you would like
   *  to act on behalf of.
   */
  private static final String USER_EMAIL = "admin@arahansa.com";
  //private static final String USER_EMAIL = "me.arahansa@gmail.com";
